...
# .containers/. For pypy27, $PYPY_CHECKOUT (default ~/Projects/pypy/pypy) is
# mounted as a throwaway overlay at /pypy and put on sys.path, which makes rpython
# importable.
set -eu
...
pypy27)
    ...
    extra_mount="-v $pypy_checkout:/pypy:O"
    extra_path=:/pypy
    ;;
*)
